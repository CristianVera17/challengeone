  ...
  return (
    <div>
        ...
        <div className="footer-box">
            ...
            <div className="footer-box-int">
                <div className="footer-box-int-one">
                    ...
                    <div className="text-1xl font-bold text-red-500">MARVEL INSIDER</div>
                    <div className="text-3xl font-bold text-white">Watch, Earn, Redeem!</div>
                    <div className="text-white">Get rewarded for doing what you already do as a fan.</div>
                    <div><button className="mt-5 text-white">JOIN NOW</button></div>
        ...
        <div className="footer-box-two">
            ...
            <div className="footer-box-one-two-tree">
                <div className="box-insider-footer">
                    <div>
                    <img className="insider-box" alt="Insider-log" src={Insiderlogo}/>
                    </div>
                    <div className="ml-5">
                    <p className="text-white">MARVEL INSIDER</p>
                    <p className="text-white">Get Rewarded for Being a Marvel Fan</p>
                    </div>
                ...
                <div className="box-unlimited-footer">
                    ...
                    <div className="ml-10">
                        ...
                        <p className="text-unlimited text-white">Access Over 30,000+ Digital Comics</p>
                    </div>
        ...
        <div className="box-cookie">
            ...
            <div><p className="text-footer text-gray-500">Terms of Use</p></div>
            <div><p className="text-footer text-gray-500">Privacy Policy</p></div>
            <dip className="text-footer text-gray-500">Your US State Privacy Rights</dip>
            <dip className="text-footer text-gray-500">Children's Online Privacy Policy</dip>
